...
public class UserController extends Controller {
    ...
    public UserController() {
        ...
        view.getNo_hp().addKeyListener(new KeyAdapter() {
    ...
    public void tampilData(boolean cari) {
        try {
            ...
            while (data.next()) {
                ...
                Object[] dataTable = {no, data.getString("nama"), data.getString("username"), data.getString("alamat"), data.getString("no_hp"), data.getString("rfid"), data.getString("role")};
...
//        tampilData(false);
    ...
    public void simpanData() {
        ...
        String rfid = view.getTxtrfid().getText();
    ...
    public void editData() {
        ...
        view.getNamaUser().setText(userList.get(row)[1].toString());
        view.getUsername().setText(userList.get(row)[2].toString());
        view.getAlamat().setText(userList.get(row)[3].toString());

        view.getNo_hp().setText(userList.get(row)[4].toString());
        view.getTxtrfid().setText(userList.get(row)[5].toString());

        view.getRole().setSelectedItem(userList.get(row)[6].toString());
        view.getPassword().setText(userList.get(row)[7].toString());
        status = 2;
